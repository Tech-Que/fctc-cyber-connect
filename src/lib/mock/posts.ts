...
const newId = () => `post_${nanoid(8)}`;

const secPlusPostId = newId();
const wiresharkPostId = newId();
const internshipsPostId = newId();
const cysaPostId = newId();
const laptopPostId = newId();

export const POST_IDS = {
  secPlus: secPlusPostId,
  wireshark: wiresharkPostId,
  internships: internshipsPostId,
  cysa: cysaPostId,
  laptop: laptopPostId,
};
